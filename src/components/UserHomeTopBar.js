...
//     // Add this function to mark a notification as read
//     const handleNotificationClick = async (notification) => {
//         try {
//             if (!notification.is_read) {
//                 await fetch(`http://localhost:4000/api/notifications/${notification.notification_id}`, {
...
//     // Add this function to toggle notifications panel
//     const toggleNotifications = () => {
//         setIsNotificationsOpen(!isNotificationsOpen);
//         if (isDropdownOpen) {
//             setIsDropdownOpen(false);
...
//     // Add event listener for clicking outside notifications
//     useEffect(() => {
//         const handleClickOutside = (event) => {
//             if (dropdownRef.current && !dropdownRef.current.contains(event.target)) {
//                 setIsDropdownOpen(false);
...
//                 <div className="topbar-actions">
//                     {user && (
//                         // Add this JSX code before the user-profile div in topbar-actions div
//                         <div className="notification-bell" ref={notificationsRef}>
